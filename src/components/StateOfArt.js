    ...
    <section className="content state--bg">
        <div className="max-content state">
            ...
            <article className="state__article">
                <h1 className="state__title">State of the Art Infrastructure</h1>
                <p className="state__description">With reliability and speed in mind, worldwide data centers provide the backbone for ultra-fast connectivity. 
